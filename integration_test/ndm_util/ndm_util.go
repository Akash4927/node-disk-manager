...
// ApplyCRDs is a simple function to apply CRD yaml using `kubectl`
func ApplyCRDs() {
	// Same as minikubeadm package
	var (
	...
	runCommand("kubectl apply -f " + path.Join(GetNDMDir(), "samples/crd-disk.yaml"))
}
